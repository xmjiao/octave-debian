...
libinterp/dldfcn/__delaunayn__.df: CPPFLAGS += $(QHULL_CPPFLAGS)
...
libinterp/dldfcn/__eigs__.df: CPPFLAGS += $(ARPACK_CPPFLAGS) $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/__fltk_uigetfile__.df: CPPFLAGS += $(FLTK_CPPFLAGS) $(FT2_CPPFLAGS)
...
libinterp/dldfcn/__glpk__.df: CPPFLAGS += $(GLPK_CPPFLAGS)
...
libinterp/dldfcn/__init_fltk__.df: CPPFLAGS += $(FLTK_CPPFLAGS) $(FT2_CPPFLAGS) $(FONTCONFIG_CPPFLAGS)
...
libinterp/dldfcn/__init_gnuplot__.df: CPPFLAGS += $(FT2_CPPFLAGS) $(FONTCONFIG_CPPFLAGS)
...
libinterp/dldfcn/__osmesa_print__.df: CPPFLAGS += $(OSMESA_CPPFLAGS) $(FT2_CPPFLAGS)
...
libinterp/dldfcn/__voronoi__.df: CPPFLAGS += $(QHULL_CPPFLAGS)
...
libinterp/dldfcn/amd.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/audiodevinfo.df: CPPFLAGS += $(PORTAUDIO_CPPFLAGS)
...
libinterp/dldfcn/audioread.df: CPPFLAGS += $(SNDFILE_CPPFLAGS)
...
libinterp/dldfcn/ccolamd.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/chol.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/colamd.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/convhulln.df: CPPFLAGS += $(QHULL_CPPFLAGS)
...
libinterp/dldfcn/dmperm.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/fftw.df: CPPFLAGS += $(FFTW_XCPPFLAGS)
...
libinterp/dldfcn/qr.df: CPPFLAGS += $(QRUPDATE_CPPFLAGS) $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/symbfact.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)
...
libinterp/dldfcn/symrcm.df: CPPFLAGS += $(SPARSE_XCPPFLAGS)

...
case 63:
YY_RULE_SETUP
#line 1460 "parse-tree/lex.ll"
{ CMD_OR_OP (":", ':', true); }
	YY_BREAK
case 64:
YY_RULE_SETUP
#line 1461 "parse-tree/lex.ll"
{ CMD_OR_OP (".+", EPLUS, false); }
	YY_BREAK
case 65:
YY_RULE_SETUP
#line 1462 "parse-tree/lex.ll"
{ CMD_OR_OP (".-", EMINUS, false); }
	YY_BREAK
case 66:
YY_RULE_SETUP
#line 1463 "parse-tree/lex.ll"
{ CMD_OR_OP (".*", EMUL, true); }
	YY_BREAK
case 67:
YY_RULE_SETUP
#line 1464 "parse-tree/lex.ll"
{ CMD_OR_OP ("./", EDIV, true); }
	YY_BREAK
case 68:
YY_RULE_SETUP
#line 1465 "parse-tree/lex.ll"
{ CMD_OR_OP (".\\", ELEFTDIV, true); }
	YY_BREAK
case 69:
YY_RULE_SETUP
#line 1466 "parse-tree/lex.ll"
{ CMD_OR_OP (".^", EPOW, true); }
	YY_BREAK
case 70:
YY_RULE_SETUP
#line 1467 "parse-tree/lex.ll"
{ CMD_OR_OP (".**", EPOW, false); }
	YY_BREAK
case 71:
YY_RULE_SETUP
#line 1468 "parse-tree/lex.ll"
{ CMD_OR_OP ("<=", EXPR_LE, true); }
	YY_BREAK
case 72:
YY_RULE_SETUP
#line 1469 "parse-tree/lex.ll"
{ CMD_OR_OP ("==", EXPR_EQ, true); }
	YY_BREAK
case 73:
YY_RULE_SETUP
#line 1470 "parse-tree/lex.ll"
{ CMD_OR_OP ("~=", EXPR_NE, true); }
	YY_BREAK
case 74:
YY_RULE_SETUP
#line 1471 "parse-tree/lex.ll"
{ CMD_OR_OP ("!=", EXPR_NE, false); }
	YY_BREAK
case 75:
YY_RULE_SETUP
#line 1472 "parse-tree/lex.ll"
{ CMD_OR_OP (">=", EXPR_GE, true); }
	YY_BREAK
case 76:
YY_RULE_SETUP
#line 1473 "parse-tree/lex.ll"
{ CMD_OR_OP ("&", EXPR_AND, true); }
	YY_BREAK
case 77:
YY_RULE_SETUP
#line 1474 "parse-tree/lex.ll"
{ CMD_OR_OP ("|", EXPR_OR, true); }
	YY_BREAK
case 78:
YY_RULE_SETUP
#line 1475 "parse-tree/lex.ll"
{ CMD_OR_OP ("<", EXPR_LT, true); }
	YY_BREAK
case 79:
YY_RULE_SETUP
#line 1476 "parse-tree/lex.ll"
{ CMD_OR_OP (">", EXPR_GT, true); }
	YY_BREAK
case 80:
YY_RULE_SETUP
#line 1477 "parse-tree/lex.ll"
{ CMD_OR_OP ("*", '*', true); }
	YY_BREAK
case 81:
YY_RULE_SETUP
#line 1478 "parse-tree/lex.ll"
{ CMD_OR_OP ("/", '/', true); }
	YY_BREAK
...
case 82:
YY_RULE_SETUP
#line 1484 "parse-tree/lex.ll"
{ return curr_lexer->handle_op ("\\", LEFTDIV); }
	YY_BREAK
case 83:
YY_RULE_SETUP
#line 1486 "parse-tree/lex.ll"
{ CMD_OR_OP ("^", POW, true); }
	YY_BREAK
case 84:
YY_RULE_SETUP
#line 1487 "parse-tree/lex.ll"
{ CMD_OR_OP ("**", POW, false); }
	YY_BREAK
case 85:
YY_RULE_SETUP
#line 1488 "parse-tree/lex.ll"
{ CMD_OR_OP ("&&", EXPR_AND_AND, true); }
	YY_BREAK
case 86:
YY_RULE_SETUP
#line 1489 "parse-tree/lex.ll"
{ CMD_OR_OP ("||", EXPR_OR_OR, true); }
	YY_BREAK
case 87:
YY_RULE_SETUP
#line 1490 "parse-tree/lex.ll"
{ CMD_OR_OP ("<<", LSHIFT, false); }
	YY_BREAK
case 88:
YY_RULE_SETUP
#line 1491 "parse-tree/lex.ll"
{ CMD_OR_OP (">>", RSHIFT, false); }
	YY_BREAK
case 89:
YY_RULE_SETUP
#line 1493 "parse-tree/lex.ll"
{
...
case 90:
YY_RULE_SETUP
#line 1501 "parse-tree/lex.ll"
{ CMD_OR_UNARY_OP ("+", '+', true); }
	YY_BREAK
case 91:
YY_RULE_SETUP
#line 1502 "parse-tree/lex.ll"
{ CMD_OR_UNARY_OP ("-", '-', true); }
	YY_BREAK
case 92:
YY_RULE_SETUP
#line 1504 "parse-tree/lex.ll"
{ CMD_OR_UNARY_OP ("~", EXPR_NOT, true); }
	YY_BREAK
case 93:
YY_RULE_SETUP
#line 1505 "parse-tree/lex.ll"
{ CMD_OR_UNARY_OP ("!", EXPR_NOT, false); }
	YY_BREAK
case 94:
YY_RULE_SETUP
#line 1507 "parse-tree/lex.ll"
{
    bool at_beginning_of_statement
      = (! (curr_lexer->whitespace_is_significant ()
            || curr_lexer->looking_at_object_index.front ()));
...
case 96:
YY_RULE_SETUP
#line 1519 "parse-tree/lex.ll"
{ CMD_OR_UNARY_OP ("++", PLUS_PLUS, false); }
	YY_BREAK
case 97:
YY_RULE_SETUP
#line 1520 "parse-tree/lex.ll"
...
case 102:
YY_RULE_SETUP
#line 1613 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("+=", ADD_EQ); }
	YY_BREAK
case 103:
YY_RULE_SETUP
#line 1614 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("-=", SUB_EQ); }
	YY_BREAK
case 104:
YY_RULE_SETUP
#line 1615 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("*=", MUL_EQ); }
	YY_BREAK
case 105:
YY_RULE_SETUP
#line 1616 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("/=", DIV_EQ); }
	YY_BREAK
case 106:
YY_RULE_SETUP
#line 1617 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("\\=", LEFTDIV_EQ); }
	YY_BREAK
case 107:
YY_RULE_SETUP
#line 1618 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP (".+=", ADD_EQ); }
	YY_BREAK
case 108:
YY_RULE_SETUP
#line 1619 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP (".-=", SUB_EQ); }
	YY_BREAK
case 109:
YY_RULE_SETUP
#line 1620 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP (".*=", EMUL_EQ); }
	YY_BREAK
case 110:
YY_RULE_SETUP
#line 1621 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("./=", EDIV_EQ); }
	YY_BREAK
case 111:
YY_RULE_SETUP
#line 1622 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP (".\\=", ELEFTDIV_EQ); }
	YY_BREAK
case 112:
YY_RULE_SETUP
#line 1623 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("^=", POW_EQ); }
	YY_BREAK
case 113:
YY_RULE_SETUP
#line 1624 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("^=", POW_EQ); }
	YY_BREAK
case 114:
YY_RULE_SETUP
#line 1625 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP (".^=", EPOW_EQ); }
	YY_BREAK
case 115:
YY_RULE_SETUP
#line 1626 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP (".^=", EPOW_EQ); }
	YY_BREAK
case 116:
YY_RULE_SETUP
#line 1627 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("&=", AND_EQ); }
	YY_BREAK
case 117:
YY_RULE_SETUP
#line 1628 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("|=", OR_EQ); }
	YY_BREAK
case 118:
YY_RULE_SETUP
#line 1629 "parse-tree/lex.ll"
{ CMD_OR_COMPUTED_ASSIGN_OP ("<<=", LSHIFT_EQ); }
	YY_BREAK
case 119:
YY_RULE_SETUP
#line 1630 "parse-tree/lex.ll"
